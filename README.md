...
[![Release](https://img.shields.io/badge/release-1.16.3-6c63ff?style=flat-square)](https://github.com/Lemon-Obsidian/git-sync/releases/latest)
...
| 버전 | 주요 변경 |
|------|-----------|
| **1.16.3** | commit-push · full-sync 커맨드에서 변경사항이 없어도 push 진행하도록 수정 |
...
| **1.12.0** | 에러 발생 시 복사 가능한 에러 모달 추가 — 에러 메시지 전체 표시 + 클립보드 복사 버튼 |
